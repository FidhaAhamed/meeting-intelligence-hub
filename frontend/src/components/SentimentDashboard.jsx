    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-1">Click a segment to view the exact chunked text</p>
        </div>
          ...
          {selectedSegment !== null && (
            <div className="bg-gray-50 rounded-lg p-4 text-sm text-gray-700 border border-gray-200">
              ...
              <p className="text-xs text-gray-400 mb-2">
                Lines {data.segments[selectedSegment].line_start}-{data.segments[selectedSegment].line_end}
                {data.segments[selectedSegment].timestamp_start && data.segments[selectedSegment].timestamp_end
                  ? ` - ${data.segments[selectedSegment].timestamp_start}-${data.segments[selectedSegment].timestamp_end}`
                  : ''}
                {data.segments[selectedSegment].speaker_hint
                  ? ` - ${data.segments[selectedSegment].speaker_hint}`
                  : ''}
              </p>
